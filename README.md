...
> Native code is harder to decompile than Java code. That's what you write secret keys in C/C++ code.
...
> JWS Payload: The bytes to be secured -- aka, the message. The payload can contain an arbitrary sequence of bytes.
> JWS Signature: A byte array containing the cryptographic material that secures the JWS Header and the JWS Payload.
> For more information, see https://tools.ietf.org/html/rfc7515
...
[mainactivity]: app/src/main/java/com/catherine/securitysample/MainActivity.java
[config.cpp]: app/src/main/jni/Config.cpp
[jnihelper]: app/src/main/java/com/catherine/securitysample/JNIHelper.java
[safetynet]: app/src/main/java/com/catherine/securitysample/safety_net
[android.mk]: app/src/main/jni/Android.mk
[application.mk]: app/src/main/jni/Application.mk
...
[androiddeviceverifier]: app/src/main/java/com/catherine/securitysample/safety_net/AndroidDeviceVerifier.java
[attestationasynctask]: app/src/main/java/com/catherine/securitysample/safety_net/AttestationAsyncTask.java
[safetynetutils]: app/src/main/java/com/catherine/securitysample/safety_net/SafetyNetUtils.java
